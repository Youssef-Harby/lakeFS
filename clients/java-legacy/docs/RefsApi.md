...
<a name="dumpRefsStatus"></a>
# **dumpRefsStatus**
> RefsDumpStatus dumpRefsStatus(repository, taskId)
...
<a name="dumpRefsSubmit"></a>
# **dumpRefsSubmit**
> TaskInfo dumpRefsSubmit(repository)
...
<a name="restoreRefsStatus"></a>
# **restoreRefsStatus**
> RefsRestoreStatus restoreRefsStatus(repository, taskId)
...
<a name="restoreRefsSubmit"></a>
# **restoreRefsSubmit**
> TaskInfo restoreRefsSubmit(repository, refsDump)
