...
*RefsApi* | [**dump_refs_status**](docs/RefsApi.md#dump_refs_status) | **GET** /repositories/{repository}/refs/dump/{task_id} | Dump repository refs (tags, commits, branches) to object store
*RefsApi* | [**dump_refs_submit**](docs/RefsApi.md#dump_refs_submit) | **POST** /repositories/{repository}/refs/dump | Dump repository refs (tags, commits, branches) to object store
...
*RefsApi* | [**restore_refs_status**](docs/RefsApi.md#restore_refs_status) | **GET** /repositories/{repository}/refs/restore/{task_id} | Restore repository refs (tags, commits, branches) from object store
*RefsApi* | [**restore_refs_submit**](docs/RefsApi.md#restore_refs_submit) | **POST** /repositories/{repository}/refs/restore | Restore repository refs (tags, commits, branches) from object store
