...
| [**dumpRefsStatus**](RefsApi.md#dumpRefsStatus) | **GET** /repositories/{repository}/refs/dump/{task_id} | Dump repository refs (tags, commits, branches) to object store |
| [**dumpRefsSubmit**](RefsApi.md#dumpRefsSubmit) | **POST** /repositories/{repository}/refs/dump | Dump repository refs (tags, commits, branches) to object store |
...
| [**restoreRefsStatus**](RefsApi.md#restoreRefsStatus) | **GET** /repositories/{repository}/refs/restore/{task_id} | Restore repository refs (tags, commits, branches) from object store |
| [**restoreRefsSubmit**](RefsApi.md#restoreRefsSubmit) | **POST** /repositories/{repository}/refs/restore | Restore repository refs (tags, commits, branches) from object store |
...
<a id="dumpRefsStatus"></a>
# **dumpRefsStatus**
> RefsDumpStatus dumpRefsStatus(repository, taskId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      RefsDumpStatus result = apiInstance.dumpRefsStatus(repository, taskId)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RefsApi#dumpRefsStatus");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="dumpRefsSubmit"></a>
# **dumpRefsSubmit**
> TaskInfo dumpRefsSubmit(repository).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String repository = "repository_example"; // String | 
    try {
      TaskInfo result = apiInstance.dumpRefsSubmit(repository)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RefsApi#dumpRefsSubmit");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="restoreRefsStatus"></a>
# **restoreRefsStatus**
> RefsRestoreStatus restoreRefsStatus(repository, taskId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String taskId = "taskId_example"; // String | 
    try {
      RefsRestoreStatus result = apiInstance.restoreRefsStatus(repository, taskId)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RefsApi#restoreRefsStatus");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="restoreRefsSubmit"></a>
# **restoreRefsSubmit**
> TaskInfo restoreRefsSubmit(repository, refsDump).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      TaskInfo result = apiInstance.restoreRefsSubmit(repository, refsDump)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RefsApi#restoreRefsSubmit");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
