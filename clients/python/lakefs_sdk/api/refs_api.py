...
class RefsApi(object):
    ...
    @validate_arguments
    def dump_refs_status(self, repository : StrictStr, task_id : StrictStr, **kwargs) -> RefsDumpStatus:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: RefsDumpStatus
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the dump_refs_status_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.dump_refs_status_with_http_info(repository, task_id, **kwargs)  # noqa: E501

    @validate_arguments
    def dump_refs_status_with_http_info(self, repository : StrictStr, task_id : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """Dump repository refs (tags, commits, branches) to object store  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.dump_refs_status_with_http_info(repository, task_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(RefsDumpStatus, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method dump_refs_status" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/repositories/{repository}/refs/dump/{task_id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def dump_refs_submit(self, repository : StrictStr, **kwargs) -> TaskInfo:  # noqa: E501
        """Dump repository refs (tags, commits, branches) to object store  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the dump_refs_submit_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.dump_refs_submit_with_http_info(repository, **kwargs)  # noqa: E501

    @validate_arguments
    def dump_refs_submit_with_http_info(self, repository : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """Dump repository refs (tags, commits, branches) to object store  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.dump_refs_submit_with_http_info(repository, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method dump_refs_submit" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/repositories/{repository}/refs/dump', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def restore_refs_status(self, repository : StrictStr, task_id : StrictStr, **kwargs) -> RefsRestoreStatus:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: RefsRestoreStatus
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the restore_refs_status_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.restore_refs_status_with_http_info(repository, task_id, **kwargs)  # noqa: E501

    @validate_arguments
    def restore_refs_status_with_http_info(self, repository : StrictStr, task_id : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """Restore repository refs (tags, commits, branches) from object store  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.restore_refs_status_with_http_info(repository, task_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(RefsRestoreStatus, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method restore_refs_status" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/repositories/{repository}/refs/restore/{task_id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def restore_refs_submit(self, repository : StrictStr, refs_dump : RefsDump, **kwargs) -> TaskInfo:  # noqa: E501
        """Restore repository refs (tags, commits, branches) from object store  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the restore_refs_submit_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.restore_refs_submit_with_http_info(repository, refs_dump, **kwargs)  # noqa: E501

    @validate_arguments
    def restore_refs_submit_with_http_info(self, repository : StrictStr, refs_dump : RefsDump, **kwargs) -> ApiResponse:  # noqa: E501
        """Restore repository refs (tags, commits, branches) from object store  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.restore_refs_submit_with_http_info(repository, refs_dump, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method restore_refs_submit" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/repositories/{repository}/refs/restore', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
