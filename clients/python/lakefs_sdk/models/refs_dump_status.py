...
class RefsDumpStatus(BaseModel):
    """
    RefsDumpStatus
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RefsDumpStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RefsDumpStatus:
        """Create an instance of RefsDumpStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RefsDumpStatus.parse_obj(obj)
