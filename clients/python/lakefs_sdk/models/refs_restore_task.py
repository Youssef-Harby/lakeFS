...
class RefsRestoreTask(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RefsRestoreTask:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RefsRestoreTask:
        """Create an instance of RefsRestoreTask from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RefsRestoreTask.parse_obj(obj)

        _obj = RefsRestoreTask.parse_obj({
            "id": obj.get("id"),
