...
export const Renderers: { [fileType in FileType]: FC<RendererComponent> } = {
  ...
  [FileType.IPYNB]: (props) => (
    <TextDownloader
      {...props}
      onReady={(text) => <IpynbRenderer {...props} text={text} />}
    />
  ),
  ...
  [FileType.TEXT]: (props) => (
    <TextDownloader
      {...props}
      onReady={(text) => <TextRenderer {...props} text={text} />}
    />
  ),
  [FileType.UNSUPPORTED]: (props) => <UnsupportedFileType {...props} />,
  [FileType.TOO_LARGE]: (props) => <ObjectTooLarge {...props} />,
};
...
export const ObjectRenderer: FC<RendererComponent> = (
  props: RendererComponent
) => {
