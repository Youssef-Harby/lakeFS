...
Since a bare repo is expected, in case of transient failure, delete the repository and recreate it as bare and retry.`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		var bo backoff.BackOff = backoff.NewConstantBackOff(pullInterval)
...
func init() {
	...
	refsRestoreCmd.Flags().Duration("pull-interval", defaultPullInterval, "pull status check interval")
	refsRestoreCmd.Flags().Duration("pull-expiry", defaultPullExpiry, "pull status check expiry")
